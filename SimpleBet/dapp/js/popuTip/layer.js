...
;!function (a) {
    ...
    j.prototype.view = function () {
        ...
        "msg" === c.skin && (c.shade = !1),
            f.innerHTML = (c.shade ? "<div " + ("string" == typeof c.shade ? 'style="' + c.shade + '"' : "") + ' class="layui-m-layershade"></div>' : "") + '<div class="layui-m-layermain" ' + (c.fixed ? "" : 'style="position:static;"') + '><div class="layui-m-layersection"><div class="layui-m-layerchild ' + (c.skin ? "layui-m-layer-" + c.skin + " " : "") + (c.className ? c.className : "") + " " + (c.anim ? "layui-m-anim-" + c.anim : "") + '" ' + (c.style ? 'style="' + c.style + '"' : "") + ">" + g + j + "</div></div></div>",
        !c.type || 2 === c.type) {
        ...
        j.prototype.action = function (a, b) {
            ...
            var e = function () {
                ...
                0 == b ? (a.no && a.no(),
                    layer.close(c.index)) : a.yes ? a.yes(c.index, this) : layer.close(c.index)
            };
            if (a.btn)
